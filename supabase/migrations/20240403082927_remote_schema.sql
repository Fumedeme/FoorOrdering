...
CREATE POLICY "allow everything" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "allow everything" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
